...
from sqlalchemy import DateTime, Enum, Float, ForeignKey, Index, String, column, func, text
...
class Detection(Base):
    ...
    __table_args__ = (
        Index("ix_detections_estate_type_created", "estate_id", "detection_type", column("created_at").desc()),
